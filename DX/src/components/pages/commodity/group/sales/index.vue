        ...
        <Scroll :isShowRight="true" ref="scroll" >
            <div class="fold" ref="basicFoldObj">
                <div class="fold-title" @click="objShowClick(basicObj)">
                    <span class="fold-name fold-name-basic">关联营销资源</span>
                ...
                <div class="fold-content" v-show="basicObj.isShow">
                    ...
                    <component :is="currentView" :class="basicObj.showScope == 'read' ? 'active' : ''" @componentView="changeView"
                               :componentData="componentData" @saveStatus="saveStatus"
                               ref="component">
                    </component>
                </div>
            </div>
            ...
            objSave(){
                ...
                try{
                    if(typeof(eval(component.save)) == "function"){
                        this.$refs.component.save(result => {});
                    }
                }catch(e){
