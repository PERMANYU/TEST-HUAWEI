            ...
            <div class="fold" ref="constraintFoldObj">
                ...
                <div class="fold-content" v-show="constraintObj.isShow">
                    <component :is="item.componentName" 
                        ...
                        :ref="'component-' + item.componentName" 
                        :id="'goods-' + item.componentName"
                        v-for="(item,index) in constraintObj.items" 
                        :key="index"></component>
                </div>
            </div>
            <div class="fold" ref="channelFoldObj">
                ...
                <div class="fold-content" v-show="channelObj.isShow">
                    <component :is="item.componentName" 
                        ...
                        :ref="'component-' + item.componentName" 
                        :id="'goods-' + item.componentName"
                        v-for="(item,index) in channelObj.items" 
                        :key="index"></component>
                </div>
            </div>
            <div class="fold" ref="saleselFoldObj">
                ...
                <div class="fold-content" v-show="saleselObj.isShow">
                    <component :is="item.componentName" 
                        ...
                        :ref="'component-' + item.componentName" 
                        :id="'goods-' + item.componentName"
                        v-for="(item,index) in saleselObj.items" 
                        :key="index"></component>
                </div>
            </div>
            <div class="fold" ref="customerFoldObj">
                ...
                <div class="fold-content" v-show="customerObj.isShow">
                    <component :is="item.componentName" 
                        ...
                        :ref="'component-' + item.componentName" 
                        :id="'goods-' + item.componentName"
                        v-for="(item,index) in customerObj.items" 
                        :key="index"></component>
                </div>
            </div>
            <div class="fold" ref="validateFoldObj">
                ...
                <div class="fold-content" v-show="validateObj.isShow">
                    <component :is="item.componentName" 
                        ...
                        :ref="'component-' + item.componentName" 
                        :id="'goods-' + item.componentName"
                        v-for="(item,index) in validateObj.items" 
                        :key="index"></component>
                </div>
            </div>
            <div class="fold" ref="listedFoldObj">
                ...
                <div class="fold-content" v-show="listedObj.isShow">
                    <component :is="item.componentName" 
                        ...
                        :ref="'component-' + item.componentName" 
                        :id="'goods-' + item.componentName"
                        v-for="(item,index) in listedObj.items" 
                        :key="index"></component>
                </div>
            </div>
        </Scroll>
...
<script>
    ...
    export default {
        ...
        components:{
            accept: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/accept'),
            attribute: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/attribute'),
            basic: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/basic'),
            constitute: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/constitute'),
            income: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/income'),
            salesLabel: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/sales-label'),
            prices: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/prices'),
            register: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/register'),
            relation: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/relation'),
            sales: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/sales'),
            share: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/share'),
            ware: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/ware'),
            estimate: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/estimate'),
            constraint: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/constraint'),
            channel: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/channel'),
            salesel: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/salesel'),
            customer: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/customer'),
            validate: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/validate'),
            listed: () => import('@/components/pages/goodsviewlist/group/list/group/goods/group/listed'),
