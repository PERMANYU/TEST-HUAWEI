<template>
	<div class="relation">
		...
		<Pagination v-show="offerRels.length > 0" 
				...
				@pageSizeChange="offerRelsPageSizeChange">
        </Pagination>
...
//                  }
		...
		methods: {
			...
			this.$axios.get(this.$api.replace(this.$api.SeeOfferRel, ['{offerId}'], [this.componentData.offerId]), {
                    params: {
                        statusCd: '1000',
