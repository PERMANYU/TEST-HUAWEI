            ...
            <div v-for="(item,index) in sceneData" :key="index">
                ...
                <div class="app__table">
                    ...
                    <Row :class="['app__table-item']" v-for="(item2,index2) in item.offerSysTestCases" :key="index2">
                        ...
                        <Col :span="4"><span class="span" @click="downLoad(item2)">下载</span></Col>
                    </Row>
...
<script type="text/javascript">
    export default {
        ...
        data() {
            return {
                offerSysTestCases:[{testCaseName:'xxx'}],
                staffId: 123,         //登录人id
                offerId: '111',       //销售品id
                systemNbr: 'ABP',
                offerBasicArray: [],
        ...
        methods: {
            //获取系统测试信息
            gteSystemData() {
                this.$axios.get(this.$api.OfferGetList+'/'+this.componentData.offerId+'/offerSysTestScene', {
                    params: {
